 ...
 */
function _lineitemtweaks_civix_civicrm_config(&$config = NULL) {
 ...
 */
function _lineitemtweaks_civix_civicrm_install() {
  _lineitemtweaks_civix_civicrm_config();
 ...
 */
function _lineitemtweaks_civix_civicrm_postInstall() {
  _lineitemtweaks_civix_civicrm_config();
  if ($upgrader = _lineitemtweaks_civix_upgrader()) {
 ...
 */
function _lineitemtweaks_civix_civicrm_uninstall() {
  _lineitemtweaks_civix_civicrm_config();
  if ($upgrader = _lineitemtweaks_civix_upgrader()) {
 ...
 */
function _lineitemtweaks_civix_civicrm_enable() {
  _lineitemtweaks_civix_civicrm_config();
  if ($upgrader = _lineitemtweaks_civix_upgrader()) {
 ...
 * @return mixed
 */
function _lineitemtweaks_civix_civicrm_disable() {
  _lineitemtweaks_civix_civicrm_config();
  if ($upgrader = _lineitemtweaks_civix_upgrader()) {
 ...
 */
function _lineitemtweaks_civix_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  if ($upgrader = _lineitemtweaks_civix_upgrader()) {
...
/**
 * @return CRM_Lineitemtweaks_Upgrader
 */
function _lineitemtweaks_civix_upgrader() {
  if (!file_exists(__DIR__ . '/CRM/Lineitemtweaks/Upgrader.php')) {
    return NULL;
  }
  else {
    return CRM_Lineitemtweaks_Upgrader_Base::instance();
  }
}
 ...
 * @return bool
 */
function _lineitemtweaks_civix_insert_navigation_menu(&$menu, $path, $item) {
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _lineitemtweaks_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item);
      }
    }
    return $found;
  }
 ...
 */
function _lineitemtweaks_civix_navigationMenu(&$nodes) {
  if (!is_callable(['CRM_Core_BAO_Navigation', 'fixNavigationMenu'])) {
    _lineitemtweaks_civix_fixNavigationMenu($nodes);
  }
}
...
function _lineitemtweaks_civix_fixNavigationMenu(&$nodes) {
  ...
  _lineitemtweaks_civix_fixNavigationMenuItems($nodes, $maxNavID, NULL);
}

function _lineitemtweaks_civix_fixNavigationMenuItems(&$nodes, &$maxNavID, $parentID) {
 ...
 */
function _lineitemtweaks_civix_civicrm_entityTypes(&$entityTypes) {
